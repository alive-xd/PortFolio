...
export const Hero: React.FC = () => {
  return (
    <section id="home" className="hero section">
      <div className="container">
        <div className="hero-grid-centered">
          ...
          <div className="social-links">
            ...
            <a href="https://instagram.com/sushen.pvt" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
      ...
      <style>{`
        /* Override grid to center everything on single column */
        .hero .container {
          display: flex;
        ...
        /* Override main stylesheet grid defaults */
        .hero-grid {
